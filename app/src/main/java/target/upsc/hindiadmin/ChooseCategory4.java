...
public class ChooseCategory4 extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    DatabaseReference mRef;
    RecyclerView.LayoutManager layoutManager;
    String tag,key1,key2,key3;
    Button button;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.choose_category_4);
        ...
        mRef = FirebaseDatabase.getInstance().getReference().
                child("QuizeCategoryStruct").child(key1).child(key1).child(key2).child(key2).child(key3).child(key3);
                ...
                new FirebaseRecyclerAdapter<CategoryListInfo, CategoryListHolder>(options) {
                    ...
                    protected void onBindViewHolder
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                String key4=model.getPid();
                                if(tag.equals("addquize"))
                                { Intent intent=new Intent(ChooseCategory4.this, AddQuize.class);
                                ...
                                if(tag.equals("deletequize"))
                                {Intent intent=new Intent(ChooseCategory4.this, DeleteQuize.class);
                                    intent.putExtra("key1",key1);
                                    intent.putExtra("key2",key2);
                                    intent.putExtra("key3",key3);
                                    intent.putExtra("key4",key4);
