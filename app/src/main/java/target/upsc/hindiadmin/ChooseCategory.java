...
public class ChooseCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(tag.equals("addquize")||tag.equals("deletequize")) {

            mRef = FirebaseDatabase.getInstance().getReference().child("QuizeCategoryStruct");
        }
        if(tag.equals("deletevideo")||tag.equals("addvideo")) {
                    ...
                    protected void onBindViewHolder
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                { Intent intent=new Intent(ChooseCategory.this, ChooseCategory2.class);
                                ...
                                if(tag.equals("deletevideo"))
                                {Intent intent=new Intent(ChooseCategory.this, DeleteVideo.class);
                                    intent.putExtra("key",key);
                                    startActivity(intent);

                                }
                                if(tag.equals("addvideo"))
                                {Intent intent=new Intent(ChooseCategory.this, AddVideo.class);
                                    intent.putExtra("key",key);
                                    startActivity(intent);
