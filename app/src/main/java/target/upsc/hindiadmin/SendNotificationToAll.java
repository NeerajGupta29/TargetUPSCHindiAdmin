...
public class SendNotificationToAll extends AppCompatActivity {
    private TextInputLayout textInputNotification,textInputTitle;
    private String notification,URL,title;
    private RequestQueue requestQueue;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.send_notification_to_all);
    ...
    public boolean SendNotification(View view){
    ...
    private  void  sendNotification(){
        ...
        try {
            ...
            Toast.makeText(SendNotificationToAll.this, "Send", Toast.LENGTH_SHORT).show();
